...
Version  : 1.2.0
Release  : 26
URL      : https://xkbcommon.org/download/libxkbcommon-1.2.0.tar.xz
Source0  : https://xkbcommon.org/download/libxkbcommon-1.2.0.tar.xz
...
%prep
%setup -q -n libxkbcommon-1.2.0
cd %{_builddir}/libxkbcommon-1.2.0
pushd ..
cp -a libxkbcommon-1.2.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617636864
...
cp %{_builddir}/libxkbcommon-1.2.0/LICENSE %{buildroot}/usr/share/package-licenses/libxkbcommon/3226d82e896c1428856ecbb68d3eb29cba7c4b19
pushd ../build32/
