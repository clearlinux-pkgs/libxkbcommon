...
Source0  : http://xkbcommon.org/download/libxkbcommon-0.7.1.tar.xz
...
%prep
%setup -q -n libxkbcommon-0.7.1
pushd ..
cp -a libxkbcommon-0.7.1 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1485713904
