...
Version  : 1.0.2
Release  : 23
URL      : http://xkbcommon.org/download/libxkbcommon-1.0.2.tar.xz
Source0  : http://xkbcommon.org/download/libxkbcommon-1.0.2.tar.xz
...
%prep
%setup -q -n libxkbcommon-1.0.2
cd %{_builddir}/libxkbcommon-1.0.2
pushd ..
cp -a libxkbcommon-1.0.2 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605918985
...
cp %{_builddir}/libxkbcommon-1.0.2/LICENSE %{buildroot}/usr/share/package-licenses/libxkbcommon/3226d82e896c1428856ecbb68d3eb29cba7c4b19
pushd ../build32/
