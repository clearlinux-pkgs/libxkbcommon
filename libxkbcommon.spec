...
Version  : 1.0.3
Release  : 24
URL      : http://xkbcommon.org/download/libxkbcommon-1.0.3.tar.xz
Source0  : http://xkbcommon.org/download/libxkbcommon-1.0.3.tar.xz
...
%prep
%setup -q -n libxkbcommon-1.0.3
cd %{_builddir}/libxkbcommon-1.0.3
pushd ..
cp -a libxkbcommon-1.0.3 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606257701
...
cp %{_builddir}/libxkbcommon-1.0.3/LICENSE %{buildroot}/usr/share/package-licenses/libxkbcommon/3226d82e896c1428856ecbb68d3eb29cba7c4b19
pushd ../build32/
