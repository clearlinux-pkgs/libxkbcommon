...
Source0  : http://xkbcommon.org/download/libxkbcommon-0.9.1.tar.xz
...
%prep
%setup -q -n libxkbcommon-0.9.1
pushd ..
cp -a libxkbcommon-0.9.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571841311
...
cp %{_builddir}/libxkbcommon-0.9.1/LICENSE %{buildroot}/usr/share/package-licenses/libxkbcommon/3226d82e896c1428856ecbb68d3eb29cba7c4b19
pushd ../build32
