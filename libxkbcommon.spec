...
Version  : 0.8.3
Release  : 16
URL      : http://xkbcommon.org/download/libxkbcommon-0.8.3.tar.xz
Source0  : http://xkbcommon.org/download/libxkbcommon-0.8.3.tar.xz
...
%prep
%setup -q -n libxkbcommon-0.8.3
pushd ..
cp -a libxkbcommon-0.8.3 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1550011193
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/libxkbcommon/LICENSE
