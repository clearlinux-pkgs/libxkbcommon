...
Source0  : http://xkbcommon.org/download/libxkbcommon-0.8.0.tar.xz
...
%prep
%setup -q -n libxkbcommon-0.8.0
pushd ..
cp -a libxkbcommon-0.8.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1533052927
