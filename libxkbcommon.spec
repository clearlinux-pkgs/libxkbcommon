...
Source0  : http://xkbcommon.org/download/libxkbcommon-0.7.0.tar.xz
Summary  : XKB API common to servers and clients (uninstalled)
...
%prep
%setup -q -n libxkbcommon-0.7.0
pushd ..
cp -a libxkbcommon-0.7.0 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1483745627
